...
// import { GLBLoader } from "./three.js-master/examples/jsm/loaders/GLBLoader.js";
...
fileInput.addEventListener('change', function(event) {
  ...
  glbLoader.load(URL.createObjectURL(file), function(glb) {
    const root = glb.scene;
    scene.add(new THREE.GridHelper(20,50, 0x888888, 0x444444));
    scene.add(root);

    const clip = glb.animations.find((clip) => clip.name === 'animation_0');
    if (clip) {
...
// const glbLoader = new GLTFLoader();
// glbLoader.load('./Task.glb', function (glb) {
//   const root = glb.scene;
//   scene.add(new THREE.GridHelper(20,50, 0x888888, 0x444444));
//   scene.add(root);
...
// gltfLoader.load('./Task.glb', function (gltf) {
